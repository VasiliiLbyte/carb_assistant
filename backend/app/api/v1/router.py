...
for r in [auth_router, projects_router, tasks_router, users_router, documents_router, risks_router, ai_router, proactive_router, webhooks_router, knowledge_router]:
